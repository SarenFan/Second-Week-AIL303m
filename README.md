...
3.  **Tổng hợp kết quả (Aggregate)**: Sau khi vòng lặp kết thúc, bạn sẽ có K kết quả đánh giá. Hiệu suất cuối cùng của mô hình được tính bằng cách lấy **trung bình** của K kết quả này.
